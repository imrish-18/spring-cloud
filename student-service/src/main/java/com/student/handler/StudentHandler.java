...
//  
  ...
  public Mono<ServerResponse> getAllAddress(ServerRequest serverRequest) {
	   

	    return ServerResponse.ok().body(emp.getAllAddress(), Address.class);
	  }
   ...
   * @return the id
   */
  public Mono<ServerResponse> getStduentById(ServerRequest serverRequest) {
	   

	    return ServerResponse.ok().body(emp.getStudentById(serverRequest.pathVariable("id")), Student.class);
	  }
//  
//  /**
//   * Data.
...
//   * @return the mono
//   */
  public Mono<ServerResponse> saveNewStudent(ServerRequest serverRequest) {
  ...
  public Mono<ServerResponse> updateById(ServerRequest serverRequest) {
	    ...
	    return ServerResponse.ok().body(emp.updateStudentById(serverRequest.pathVariable("id")),Student.class);
	  }
